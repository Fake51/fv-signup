<?php 
    ...
    class DeltagerTilmeldingPratiskGodkend11 extends SignupPage
    {
    	...
    	function loadJSON($url){
    		...
    		curl_setopt($c, CURLOPT_HTTPHEADER, array('Host: infosys-test.fastaval.dk'));
    		$data = curl_exec($c);
    		curl_close($c);
...
//			    'id'          => $user_id,
            ...
            $signup_data['entrance'][] = array('entrance_id'=>40);
			...
			*/
			...
			if ($customer['scenarieskrivningskonkurrence']==1)
				$signup_data['activity'][] = array('schedule_id' => 460,'priority' => 1,'type' => "spiller");
				
			if ($customer['boardgame_competition']==1)
				$signup_data['activity'][] = array('schedule_id' => 465,'priority' => 1,'type' => "spiller");
			...
			curl_setopt($curl, CURLOPT_HTTPHEADER, array('Host: infosys-test.fastaval.dk'));
