<?php
    ...
    class DeltagerTilmeldingPakkePage extends SignupPage
    {
        ...
        public function render()
        {
        	...
        	<form method="post" action="<?php echo get_next_step_name();?>" onSubmit='return validate_form(this);' id='form-next'>
                ...
                <div id='tilmelding-info'>
                    ...
                    <div class='box'>
                        ...
                        <p>
                            <div style='float:right;margin-top:-50px;'>
                                <input class="button" id='package_everything' type="button" value="Næste side">
                            </div>
                            <script>
                                jQuery(document).ready(function(){
                                    jQuery('#package_everything').click(function(){
                                        
                                        jQuery.post('<?php echo plugin_dir_url(__FILE__);?>package-solution-sub.php', {
                                            select: '',
                                        },
                                        function(response) 
                                        {
                                            jQuery('#form-next').submit();
                                        });
                                    });
                                });
                            </script>
                    ...
                    <div class='box'>
                        <h3 style='margin-top:0;'><?=__tm('package_headline_1');?><!-- Jeg vælger selv alt - brætspiller --></h3>
                        <input type='hidden' value='0' id='is_package' name='is_package'>
                        <p><?=__tm('package_text_1');?> <!-- Du får adgang til hele tilmeldingen, men du ser som udgangspunkt kun brætspil på aktivitetsoversigten. --></p>
                        <p>
                            <div style='float:right;margin-top:-50px;'>
                                <input class="button" id='package_boardgame' type="button" value="Næste side">
                            </div>
                            <script>
                                jQuery(document).ready(function(){
                                    jQuery('#package_boardgame').click(function(){
                    ...
                    <div class='box'>
                        <h3 style='margin-top:0;'><?=__tm('package_headline_2');?><!-- Jeg vælger selv alt - rollespiler --></h3>
                        <input type='hidden' value='0' id='is_package' name='is_package'>
                        <p><?=__tm('package_text_2');?><!-- Du får adgang til hele tilmeldingen, men du ser som udgangspunkt kun rollespil på aktivitetsoversigten. --></p>
                        <p>
                            <div style='float:right;margin-top:-50px;'>
                                <input class="button" id='package_rpg' type="button" value="Næste side">
                            </div>
                            <script>
                                jQuery(document).ready(function(){
                                    jQuery('#package_rpg').click(function(){
