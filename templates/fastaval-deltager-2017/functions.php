...
function myfunc_get_pages()
{
    ...
    include("tilmelding_3_pakke.php");
    myfunc_add_page(new DeltagerTilmeldingPakkePage());
    ...
    include("tilmelding_6_mad.php");
    myfunc_add_page(new DeltagerTilmeldingMadPage6());

    include("tilmelding_7_aktiviteter.php");
    myfunc_add_page(new DeltagerTilmeldingAktiviteterPage7());

    include("tilmelding_8_gds.php");
    myfunc_add_page(new DeltagerTilmeldingGDSPage8());

    include("tilmelding_9_wear.php");
    myfunc_add_page(new DeltagerTilmeldingWearPage9());

    include("tilmelding_10_moreinfo.php");
    myfunc_add_page(new DeltagerTilmeldingMoreInfoPage10());

    include("tilmelding_11_godkend.php");
    myfunc_add_page(new DeltagerTilmeldingPratiskGodkend11());

    include("tilmelding_12_tilmeldt.php");
