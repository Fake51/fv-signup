     ...
     class aktiviteter_v1
     {
        ...
        function ft_aktiviteterByDayJSON($day,$caption,$afviklinger){
            ...
            <ul class='type-selector selector-day-<?php echo $day;?>' data-day='<?php echo $day;?>'>
                <li  data-day='<?php echo $day?>' data-type='' class='selected'><?php __etm('Alle aktiviteter');?><!-- <span class='value-0'>0</span>--></li>
                <li  data-day='<?php echo $day?>' data-type='rolle'><?php __etm('Rollespil');?><!-- <span class='value-0'>0</span>--></li>
                <li  data-day='<?php echo $day?>' data-type='braet'><?php __etm('Brætspil');?><!-- <span class='value-0'>0</span>--></li>
                <li  data-day='<?php echo $day?>' data-type='live'><?php __etm('Live-rollespil');?><!-- <span class='value-0'>0</span>--></li>
                <li  data-day='<?php echo $day?>' data-type='workshop'><?php __etm('Workshop');?><!-- <span class='value-0'>0</span>--></li>
                <li  data-day='<?php echo $day?>' data-type='figur'><?php __etm('Figurspil');?><!-- <span class='value-0'>0</span>--></li>
                <li  data-day='<?php echo $day?>' data-type='magic'><?php __etm('Magic');?><!-- <span class='value-0'>0</span>--></li>
                <li  data-day='<?php echo $day?>' data-type='ottoviteter'><?php __etm('Events & Workshops');?><!-- <span class='value-0'>0</span>--></li>
            </ul>
