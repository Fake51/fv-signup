	...
	if ($_SESSION['registered']!="1")
	{
        ...
        foreach($posts as $post)
        {
            if (tm_getForm("prio_".$post->ID)!=""){
                add_post_meta($post->ID, "prio_".$post->ID, tm_getForm("prio_".$post->ID));
            }
        }
		...
		<fieldset id="data">
			...
			<p><strong>Tilmeldings-ID: <?php echo $post_id?></strong></p>
			<p>&nbsp;</p>
		...
		<fieldset id="pay">
            ...
            <ul>
                ...
                <!-- <li><strong>Tekst til beskedfeltet: <?php echo $post_id;?></strong></li> -->
            </ul>
