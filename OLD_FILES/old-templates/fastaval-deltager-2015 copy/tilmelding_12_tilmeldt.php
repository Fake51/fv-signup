		...
		function render()
		{
    		...
    		if (!$is_tilmeldt)
    		{
    			...
    			if ($customer['scenarieskrivningskonkurrence']==1)
    				$signup_data['activity'][] = array('schedule_id' => 98,'priority' => 1,'type' => "spiller");
    				
    			if ($customer['boardgame_competition']==1)
    				$signup_data['activity'][] = array('schedule_id' => 89,'priority' => 1,'type' => "spiller");
            ...
            if ($show_tilmeldt)
            {
                ...
                <div id="tilmelding-info">
                    ...
                    <h3><?php __etm('Betal inden for 14 dage');?></h3>
                    ...
                    <p><?php __etm('Du skal dog huske at betale inden 14 dage. Tilmeldinger der ikke er betalt efter 14 dage vil blive annulleret. Dette er en ændring fra tidligere år. Fastaval har i en række år blandt andet haft problemer med wear og mad, der bliver betalt, men ikke betalt og afhentet, hvilket koster Fastaval penge. Derfor bliver vi nødt til at bede om at du betaler på forhånd. På den måde kan vi mindske vores spild, så vi kan bruge pengene på noget sjovere.');?></p>
                    ...
                    <ul>
                        <li><?php __etm('Inden 14 dage, eller senest 15/3 skal pengene overføres til Fastavals konto - ellers annulleres tilmeldingen');?></li>
