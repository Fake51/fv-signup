        ...
        public function render()
        {
        	...
        	<form method="post" action="<?php echo get_next_step_name();?>" onSubmit='return validate_form(this);'>
                ...
                <div id='tilmelding-info'>
                    ...
                    <p><?php __etm('GDS står for Gør Det Selv og betyder på Fastaval, at alle deltagere giver en hånd med til at få de praktiske ting til at fungere. Kendetegnende for alle GDS-tjanserne er, at de ikke er ubehagelige eller tager bemærkelsesværdig lang tid. Vi koordinerer det, så det ikke går ud over dine andre aktiviteter og du skal maks. tage én GDS-tjans. Prioriter tre GDS-tjanser på nedenstående liste, så vi har noget at vælge imellem.</p>
<p>GDS-tjanserne er i år grupperinger af tjanser, hvor man ikke vælger noget specifikt, men i stedet et område. Hvis du ønsker en bestemt tjans, kan du skrive dette i bemærkningerne senere i tilmeldingen. Læs om de forskellige <a href="http://www.fastaval.dk/gds-tjanser/" target="_blank" style="color:#b00;">GDS-tjanser her</a>');?></p>
                    
                    
                    <?php 
                    if ($_SESSION['customer']['participant']!="deltager")
                    {
                        ?><p><?php __etm('Du har allerede i din rolle som arrangør eller forfatter/brætspilsdesigner lagt meget tid i Fastaval, og behøver derfor ikke tage en GDS-tjans. Hvis du alligevel har lyst, er du mere end velkommen til at vælge nogle tjanser.');?></p><?php 
                    } 
                    ?>
